...
_io_v7_0 = [ # Documented by @smunaut
    ...
    # UARTBone
    ("serial", 1,
        Subsignal("tx", Pins("E5")),
        Subsignal("rx", Pins("F4")),
        IOStandard("LVCMOS33")
    ),
    ...
    # N64 Cartridge Bus
    ("n64", 0,
        Subsignal("cold_reset", Pins("C4")),
        # A0 to A15
        Subsignal("ad_io",      Pins("U16 C18 R18 P17 N17 M18 F20 B20 " + \
                                     "B19 D20 L20 N18 M17 R17 T18 K18 ")),
        Subsignal("aleh",       Pins("U17")),
        Subsignal("alel",       Pins("T17")),
        Subsignal("read",       Pins("P18")),
        Subsignal("write",      Pins("U18")),
        Subsignal("nmi",        Pins("C17")),
        IOStandard("LVCMOS33"), Misc("SLEWRATE=FAST"),
    ),
    ("n64cic", 0,
        Subsignal("si_clk",   Pins("A18")),
        Subsignal("cic_dio",  Pins("A19")),
        Subsignal("cic_dclk", Pins("B18")),
        Subsignal("eep_sdat", Pins("C3")),
        IOStandard("LVCMOS33"),
    ),
]
